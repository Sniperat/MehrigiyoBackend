...
class MedicineAdmin(TabbedTranslationAdmin):
    ...
    list_display = ('id', 'name', 'title', 'image', 'order_count', 'description', 'quantity', 'review', 'weight', 'type_medicine', 'cost', 'discount', 'created_at', )
    list_filter = [TypeMedicineFilter, ]
    search_fields = ['id', 'name', 'title', 'order_count', 'description', 'quantity', 'review', 'weight', 'cost', 'discount', ]
...
class OrderModelAdmin(admin.ModelAdmin):
    date_hierarchy = 'created_at'
    list_display = ['id', 'user', 'credit_card', 'shipping_address', 'price', 'payment_type', 'payment_status', 'delivery_status', 'delivery', 'created_at', ]
    list_filter = [UserFilter, CreditCardFilter, ShippingAddressFilter, 'payment_type', 'payment_status', 'delivery_status', DeliveryFilter, ]
